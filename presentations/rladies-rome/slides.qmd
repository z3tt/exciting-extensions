...
author: "<b style='color:#ffffff;font-size:1.3em;'><a href='https://www.cedricscherer.com'>Dr. Cédric Scherer</a></b><br>&ensp;R Ladies Rome&ensp;**//**&ensp;November 10<sup>th</sup>, 2023"
format:
  revealjs:
    theme: slides.scss
...
## {#ggplot2-package data-menu-title="ggplot2" transition="zoom" .center}
...
<b style='font-size:1.1em;'><code>{ggplot2}</code> is a system for declaratively creating graphics,<br>based on ["The Grammar of Graphics"]{.simple-highlight-grn} (Wilkinson, 2005).</b>
</p>
...
![<br>ggplot2 Examples featured on ggplot2.tidyverse.org](img/basic-ggplots.png){fig-align="center" fig-alt="A collection of the versatility of ggplot2 to create basic graphs. All of them use the default grey ggplot2 theme."}



## {#ggplot-masterpieces data-menu-title="ggplot2 Masterpieces"}
...
## {#ggdist-halfeye-width-comp data-menu-title="Half-Eye Plots" .center}
...
```{r}
#| label: ggdist-halfeye-width-comp-1
#| echo: false
#| fig-width: 6.3
#| fig-height: 8
#| fig-align: center
...
```{r}
#| label: ggdist-halfeye-width-comp-2
#| echo: false
#| fig-width: 6.3
#| fig-height: 8
#| fig-align: center
...
## {#ggdist-halfeye-customize data-menu-title="Half-Eye Plots"}

```{r}
#| label: ggdist-halfeye-customize
#| fig-width: 12
#| fig-height: 6.9
#| fig-align: center
#| code-line-numbers: "2"
...
## {#ggdist-berlin-temperatures data-menu-title="Berlin Temperatures"}

![[My Contribution](https://community.storytellingwithdata.com/members/me/gallery/2c51616f-eff5-46d9-9df7-981881e6cc09) to the SWD Challenge ["Visualizing Uncertainty"](https://www.storytellingwithdata.com/blog/2019/9/3/swdchallenge-visualize-uncertainty)](img/showcase/SWD_2019_09_Uncertainty.png){fig-align="center" fig-alt="Distribution of temperatures per month measured in Berlin, Germany, visualized with a combination of half-eye and mutli-interval plots provided by the ggdist packages."}
...
## {#ggblend-multiply-lighten data-menu-title="Gradual Density Regions"}
...
## {#ggblend-multiple-geoms data-menu-title="Gradual Density Regions"}

```{r, dev="png", dev.args=list(type="cairo")}
#| label: ggblend-multiple-geoms
#| fig-width: 12
#| fig-height: 6.3
#| fig-align: center
#| code-line-numbers: "2,3"
...
## {#ggdensity-points data-menu-title="Gradual Density Regions"}

```{r}
#| label: ggdensity-points
#| fig-width: 12
#| fig-height: 6.6
#| fig-align: center
#| code-line-numbers: "2"
...
## {#comp-density-ggplot-ggdensity data-menu-title="Filled Contour Plots" .center}
...
## {#ggforce-mark-default data-menu-title="Call-Outs & Group Labels"}
...
## {#ggforce-mark-styling data-menu-title="Call-Outs & Group Labels"}
...
## {#ggforce-mark-description data-menu-title="Call-Outs & Group Labels"}
...
## {#ggforce-mark-circle data-menu-title="Call-Outs & Group Labels"}
...
## {#ggforce-mark-hull data-menu-title="Call-Outs & Group Labels"}
...
## {#ggforce-mark-modify data-menu-title="Call-Outs & Group Labels"}
...
## {#friends-mentions data-menu-title="Friends Mentions"}
...
<div style='text-align:center;font-size:.75em;color:white;'><a style='color:white;'  href="https://cedricscherer.com">www.cedricscherer.com</a>&ensp;//&ensp; <a style='color:white;' href="https://linktr.ee/cedscherer">www.linktr.ee/CedScherer</a><br><br><br>
  <a href="https://www.buymeacoffee.com/z3tt" target="_blank"><img src="https://www.buymeacoffee.com/assets/img/guidelines/download-assets-sm-1.svg" alt="Buy Me A Coffee" style="height: 50px !important;width: 174px !important;"></a>
  <br><br>
</div>
...
# `{ggdist}`<br>(continued) {background-color="#171717"}
...
# <br><b style='color:white;'>That's it Folks...</b><br><br>{background-color="#292929" background-image="img/bg-blank.png"}
